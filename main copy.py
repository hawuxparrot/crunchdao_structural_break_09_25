...
def extract_features(series_data: pd.DataFrame) -> pd.Series:
    ...
    # These can be important features themselves
    ...
    # --- Basic Statistics for both periods (raw values) ---
    # Compute these for both periods. If a period is empty, these will be NaN.
    # We will impute NaNs later.
